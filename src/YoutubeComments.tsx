    ...
    <div className="flex flex-col items-center mx-5">
      <div className="flex flex-col items-center relative z-10 transform">
        ...
        <div className="-mt-2 relative z-10">
          <div className={`bg-[#2f3040] text-white text-xl px-8 py-3 rounded-full font-bold inline-flex items-center gap-1 ${color}`}>
            <svg
        ...
        {/* Phone-like Card */}
        <div className="w-[320px] sm:w-[340px] h-[480px] rounded-[20px] border-3 border-dotted border-[#4f4f4f] border-t-0 bg-[#1e1f2b] p-4 shadow-inner overflow-hidden relative -mt-4">
          {/* Design for card */}
